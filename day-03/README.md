...
New-Item -ItemType Directory -Force "$pbl\elasticsearch\requests"
...
Copy-Item "$course\day-03\requests\04-search-and-quality.http" "$pbl\elasticsearch\requests\day-03-search.http"
```

`evidence/day-03-search.md`에는 전문 검색 1개, 정확 조건 검색 1개, bool/filter 검색 1개의 요구사항·기대·실제 결과·개선 근거를 기록합니다. `docs/quality-test.md`는 간단한 품질표가 필요한 경우 보조 양식으로 사용합니다.
