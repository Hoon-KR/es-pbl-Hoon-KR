...
현재 v1 수업은 [v1 생성 가이드](../v1/DATA_GENERATION_GUIDE.md), [v1 교재](../student-workbook-v1.md)를 따른다. 이 링크는 배포 원본에서 사용하는 링크다. 개인 복사본에서는 배포 저장소의 가이드를 열어 본다.
v2 자료와도 공유하는 범용 도구이며 v2 강의 구성 자체를 변경하지 않는다.
