...
v1 수업 기준은 [학생교재 T12/T15](../student-workbook-v1.md)와 [v1 요청](../v1/lecture-requests.http)이다.
...
5. S58: ../v1/lecture-requests.http의 count·category·재고·가격 stats·날짜 min/max를 실행하고 실제 값을 기록한다.
...
검증 요청은 [v1/lecture-requests.http](../v1/lecture-requests.http)의 S58을 사용한다. 구 검증 파일과 후속 Dashboard 참고 파일은 이번 배포에 포함하지 않는다.
